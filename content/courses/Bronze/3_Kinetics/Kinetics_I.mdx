...
<img src="https://i.imgur.com/rDynDpo.png"/>
...
Many different theories have been formed to explain how chemical kinetics functions, but each has its own pros and cons (kind of like with real gases).
...
As shown in the expression above, $\Delta[A]$ should be a negative value because the reactant is being _consumed_.
...
The units of the rate constant will depend on the **order** of the reaction, but it will always **ensure the units of the reaction rate are concentration over time.**
