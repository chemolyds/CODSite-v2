...
Although many takes into consideration the assumptions and approximations to make the model much easier to understand, the outcome of models are extremely important.
...
While the derivation of the equations from the model is beyond the scope of these notes, we will point out important facts and observations that comes from it.
If you have a physics background, it is recommended you check out the resources for this module and read about the derivation.
...
The kinetic model of gases, also known as the **kinetic molecular theory**, relies on four fundemental assumptions
We will first go over what each of the following assumptions mean in real-life context, and where they fall short.
...
The first assumption, **Gas molecules are assumed to be very small point particles**, makes sense when we take into the consideration that the distance between gas molecules tend to be very large.
In other words, the volume of all the gas molecules is much less than the volume of the container.
...
Meaning, the **kinetic energy** of gas molecules remains constatn; they are not lost into other forms of energy, such as head, noise, or potential energy.

The last assumption, **molecules do not influence one another except during elastic collisions**, is an important assumption.
It ignores any potential energy that gas molecules may have (no intermolecular forces).
...
Subsituting $pV4 for $nRT$ (ideal gas law) and rearrangement gives us the following equation:
...
This is confirmed experimentally by the **Graham's Law of Effusion**, aw we will learn in the next module.
